...
class AccountDetailRequest extends StatefulWidget {


  @override
  _AccountDetailRequestState createState() => _AccountDetailRequestState();
}

class _AccountDetailRequestState extends State<AccountDetailRequest> {


  final accountNumber=TextEditingController();


  _AccountDetailRequestState();
  @override
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
        ...
        appBar: APPBarChieledPage("App Connect Test",'Customer Account Detail Request').buildPreferredSize(),
        body: Container(
